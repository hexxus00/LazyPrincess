...
API_ID = int(environ['25564366'])
API_HASH = environ['3fbc807dbb4b4e386811d8e924c8ca95']
BOT_TOKEN = environ['6150480295:AAF8zH8p0HTIu5p82WyK1qHS4Sx7TTb-Hqs']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-10019262866210').split()]
